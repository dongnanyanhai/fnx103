...
<tbody>
    <tr>
		...
		<td align="left"><a href="http://www.finecms.net/" target="_blank">程序更新记录</a></td>
    </tr>
...
<tbody>
	...
	<tr>
		...
		<td><a href="http://www.dayrui.com/v1/<?php echo $version;?>.zip" target="_blank">http://www.dayrui.com/v1/<?php echo $version;?>.zip</a></td>
	</tr>
	<?php }?>
</tbody>
</table>
