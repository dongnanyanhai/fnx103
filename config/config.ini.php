...
return array(
	...
	'ADMIN_NAMESPACE'         => 'finecmsx',  //后台管理路径名字，默认admin
	'SYS_DOMAIN'              => '',  //域名目录，针对虚拟主机用户
	'SYS_DEBUG'               => true,  //调试模式开关，网站正式上线时建议关闭
	'SYS_LOG'                 => false,  //程序运行日志开关,日志目录（项目目录/logs/）
	'SYS_VAR_PREX'            => 'finecms_a20ad_',  //Sessoin、Cookie变量前缀
	'SYS_GZIP'                => false,  //是否Gzip压缩后输出
	'SITE_MEMBER_COOKIE'      => '539670fb6ec08c7',  //Cookie随机字符串
	...
	'SITE_MAIL_FROM'          => '978868928@qq.com',  //发送人地址
	'SITE_MAIL_AUTH'          => '1',  //是否AUTH LOGIN验证
	'SITE_MAIL_USER'          => '978868928@qq.com',  //验证用户名
	'SITE_MAIL_PASSWORD'      => '123456789',  //验证密码
