...
class pagelist extends Fn_base {
	...
	public function loadconfig($config=array()) {
	    if (empty($config)) {
	        $config = array(
				'div'     => '<div id="pages" class="pagelist">{content}</div>',
				'total'   => '<a class="pagelist-total">{content}</a>',
				'nowpage' => '<span class="pagelist-nowpage">{content}</span>',
				'page'    => '<a class="pagelist-page" href="{url}">{content}</a>',
				'pre'     => '<a class="pagelist-pre" href="{url}">{content}</a>',
				'next'    => '<a class="pagelist-next" href="{url}">{content}</a>',
				'note'    => '<a class="pagelist-note" >{content}</a>'
	        );
	    }
	...
	public function output() {
		...
		$pagelist_output = array();
		if ($this->total <= $this->num) {
			$pagelist_output['html'] = '';
			...
			$pagelist_output['total_pages'] = $this->total_pages; // 分页总数
		}
		return $pagelist_output;
